...
@section('title', 'تعریف و ثبت محصول جدید')
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-bold">
            ...
            <div class="sm:col-span-2 flex flex-wrap items-center gap-6 p-4 bg-slate-50 rounded-2xl border border-slate-200/80">
                ...
                <label class="flex items-center gap-2.5 cursor-pointer">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-4 h-4 text-[#ef394e] rounded border-slate-300">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="url" name="featured_image" value="{{ old('featured_image') }}" placeholder="https://..." required 
            ...
            <div class="sm:col-span-2">
                ...
                <input type="url" name="size_guide_image" value="{{ old('size_guide_image') }}" placeholder="https://.../size-guide.jpg" 
                       class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:border-slate-400 font-mono dir-ltr text-left">
            </div>
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="description" rows="4" 
                          class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:border-slate-400 font-normal leading-relaxed">{{ old('description') }}</textarea>
            </div>
        </div>
