...
<nav class="hidden md:block border-t border-zinc-100 bg-white/95 backdrop-blur-sm relative z-40 text-xs font-bold text-zinc-700 select-none">
    <div class="max-w-[1700px] w-full mx-auto px-4 sm:px-6 lg:px-10">
        <ul class="flex items-center gap-5 lg:gap-7 py-2.5 overflow-visible">
            <!-- 1. Home -->
            <li>
                <a href="{{ route('home') }}" class="py-2 hover:text-black transition flex items-center gap-1.5">
            ...
            <li x-data="{ open: false }" @mouseleave="open = false" class="relative">
                ...
                <div x-show="open" 
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-zinc-100 p-2 space-y-1">
                        <a href="{{ route('home') }}" class="flex items-center justify-between px-3 py-2 rounded-xl text-zinc-800 hover:bg-zinc-50 hover:text-black transition">
                                ...
                                @if($cat->children->count() > 0)
                                    <div class="pr-3 pl-2 py-1 space-y-0.5 border-r-2 border-zinc-100 mr-2 my-0.5">
                                        @foreach($cat->children as $subCat)
                                            <a href="{{ route('home', ['category' => $subCat->slug]) }}" 
            ...
            <!-- 3. Custom DTF Print -->
            <li>
                <a href="{{ route('home', ['category' => 'custom']) }}" 
            ...
            <!-- 4. Hoodie -->
            <li>
                <a href="{{ route('home', ['category' => 'hoodie']) }}" class="py-2 hover:text-black transition flex items-center gap-1.5">
            ...
            <li x-data="{ open: false }" @mouseleave="open = false" class="relative">
                ...
                <div x-show="open" 
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-zinc-100 p-2 space-y-1">
                        <a href="{{ route('account.orders') }}" class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-zinc-700 hover:bg-zinc-50 hover:text-black transition">
            ...
            <!-- 6. Discounts -->
            <li class="mr-auto">
                <a href="{{ route('home') }}" class="py-2 text-[#ef394e] font-black flex items-center gap-1.5 hover:scale-105 transition">
