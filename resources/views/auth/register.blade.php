...
<div class="max-w-md mx-auto px-4 py-16">
    <div class="bg-white rounded-3xl border border-zinc-200 p-8 shadow-sm">
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4 text-xs font-bold">
            @csrf
        ...
        <div class="mt-6 pt-6 border-t border-zinc-100 text-center text-xs font-bold text-zinc-500">
            قبلاً ثبت‌نام کرده‌اید؟ <a href="{{ route('login') }}" class="text-[#ef394e] hover:underline">ورود به حساب</a>
        </div>
    </div>
</div>
@endsection
