...
<?php $__env->startSection('title', 'افزودن اسلاید جدید'); ?>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm space-y-4 text-xs font-bold">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title')); ?>" placeholder="تیشرت‌های اختصاصی وارن" class="w-full px-4 py-2.5 bg-slate-50 border rounded-xl">
                </div>
                <div>
                    <label class="block text-slate-700 mb-1">برچسب ویژه (Tag Badge)</label>
                    <input type="text" name="tag" value="<?php echo e(old('tag')); ?>" placeholder="کالکشن جدید" class="w-full px-4 py-2.5 bg-slate-50 border rounded-xl">
                </div>
            </div>

            <div>
                <label class="block text-slate-700 mb-1">زیرعنوان / توضیح</label>
                <input type="text" name="subtitle" value="<?php echo e(old('subtitle')); ?>" placeholder="توضیحات مختصر..." class="w-full px-4 py-2.5 bg-slate-50 border rounded-xl">
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-slate-700 mb-1">متن دکمه</label>
                    <input type="text" name="button_text" value="<?php echo e(old('button_text', 'مشاهده و خرید')); ?>" class="w-full px-4 py-2.5 bg-slate-50 border rounded-xl">
                </div>
                <div>
                    <label class="block text-slate-700 mb-1">لینک هدف</label>
                    <input type="text" name="link" value="<?php echo e(old('link')); ?>" placeholder="/?category=men" class="w-full px-4 py-2.5 bg-slate-50 border rounded-xl font-mono dir-ltr text-left">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm flex items-center justify-between text-xs font-bold">
            <div class="flex items-center gap-6">
                <div>
                    ...
                    <input type="number" name="sort_order" value="<?php echo e(old('sort_order', 1)); ?>" class="w-24 px-3 py-2 bg-slate-50 border rounded-xl font-mono text-center">
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/sliders/create.blade.php ENDPATH**/ ?>