...
<?php $__env->startSection('title', 'تعریف و ثبت محصول جدید'); ?>
...
<div class="max-w-4xl mx-auto bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-sm"
     x-data="{
         ...
         salePrice: '<?php echo e(old('sale_price')); ?>',
         gallery: [''],
         selectedSizes: [],
    ...
    <div class="flex items-center justify-between pb-4 mb-6 border-b border-slate-100">
        <div>
            <h2 class="text-base font-black text-slate-900 mb-1">مشخصات کالا و قیمت‌گذاری</h2>
            <p class="text-xs text-slate-400">اطلاعات کالا را با دقت وارد کنید. محصول پس از ثبت در کاتالوگ قرار خواهد گرفت.</p>
        </div>
    ...
    <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-bold">
            ...
            <div>
                ...
                <input type="number" name="stock" value="<?php echo e(old('stock', 10)); ?>" min="0" required 
                       class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:border-slate-400 font-mono">
            </div>
            ...
            <div class="sm:col-span-2 flex flex-wrap items-center gap-6 p-4 bg-slate-50 rounded-2xl border border-slate-200/80">
                ...
                <label class="flex items-center gap-2.5 cursor-pointer">
                    <input type="checkbox" name="is_featured" value="1" <?php echo e(old('is_featured') ? 'checked' : ''); ?> class="w-4 h-4 text-[#ef394e] rounded border-slate-300">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="url" name="featured_image" value="<?php echo e(old('featured_image')); ?>" placeholder="https://..." required 
            ...
            <div class="sm:col-span-2">
                ...
                <input type="url" name="size_guide_image" value="<?php echo e(old('size_guide_image')); ?>" placeholder="https://.../size-guide.jpg" 
                       class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:border-slate-400 font-mono dir-ltr text-left">
            </div>
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="description" rows="4" 
                          class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:border-slate-400 font-normal leading-relaxed"><?php echo e(old('description')); ?></textarea>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/products/create.blade.php ENDPATH**/ ?>