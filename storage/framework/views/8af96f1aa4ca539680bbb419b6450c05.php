...
<head>
    ...
    <title><?php echo e(config('app.name', 'چاپ تیشرت وارِن | VAREN')); ?></title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/logo/VAREN_BLACK_WITHOUT%20LOGOTYPE%20AND%20SLOGAN.png')); ?>">
...
<body x-data="{ mobileDrawerOpen: false, sizeModalOpen: false }" class="flex flex-col min-h-full bg-[#f8f8f8] text-slate-800">
    ...
    <header x-data="{ atTop: true, mobileMenuOpen: false, mobileSearchOpen: false }" 
        ...
        <div class="max-w-[1700px] w-full mx-auto px-4 sm:px-6 lg:px-10">
            <div class="flex items-center justify-between h-20 gap-4 sm:gap-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 group">
                        <img src="<?php echo e(asset('images/logo/VAREN_BLACK_WITH%20LOGOTYPE%20AND%20SLOGAN.png')); ?>" 
                ...
                <div class="hidden md:flex flex-1 max-w-lg">
                    <form action="<?php echo e(route('home')); ?>" method="GET" class="w-full relative group">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute left-0 mt-2 w-52 bg-white rounded-2xl shadow-2xl border border-zinc-100 py-2 z-50 text-xs font-bold">
                            <div class="px-4 py-2 border-b border-zinc-100 mb-1">
                                <span class="text-zinc-900 block truncate"><?php echo e(auth()->user()->name); ?></span>
                                <span class="text-[10px] text-zinc-400 font-mono block"><?php echo e(auth()->user()->email); ?></span>
                            </div>

                            <a href="<?php echo e(route('account.dashboard')); ?>" class="flex items-center gap-2.5 px-4 py-2 text-zinc-700 hover:text-black hover:bg-zinc-50 transition">
                                <i class="fa-solid fa-table-columns text-zinc-400"></i> داشبورد کاربری
                            </a>

                            <a href="<?php echo e(route('account.orders')); ?>" class="flex items-center gap-2.5 px-4 py-2 text-zinc-700 hover:text-black hover:bg-zinc-50 transition">
                                <i class="fa-solid fa-bag-shopping text-zinc-400"></i> سفارش‌های من
                            </a>

                            <a href="<?php echo e(route('account.profile')); ?>" class="flex items-center gap-2.5 px-4 py-2 text-zinc-700 hover:text-black hover:bg-zinc-50 transition">
                                <i class="fa-regular fa-id-card text-zinc-400"></i> مشخصات حساب
                            </a>

                            <?php if(auth()->user()->isAdmin()): ?>
                                <div class="border-t my-1"></div>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 px-4 py-2 text-amber-600 hover:bg-amber-50 transition">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 text-xs font-bold text-zinc-800 border border-zinc-300 rounded-xl hover:bg-black hover:text-white transition">
                        ورود / عضویت
                    </a>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="group relative flex items-center gap-2 px-3.5 py-2 bg-zinc-100 hover:bg-black text-zinc-900 hover:text-white rounded-2xl transition">
        ...
        <div x-show="mobileSearchOpen" 
            ...
            <form action="<?php echo e(route('home')); ?>" method="GET" class="w-full relative">
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" 
    ...
    <div class="max-w-[1700px] w-full mx-auto px-4 sm:px-6 lg:px-10 mt-4">
        <?php if(session('success')): ?>
            <div class="p-3 mb-3 text-emerald-900 bg-emerald-50 border border-emerald-200 rounded-xl text-xs font-bold"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if(session('error')): ?>
            <div class="p-3 mb-3 text-rose-900 bg-rose-50 border border-rose-200 rounded-xl text-xs font-bold"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
    </div>

    <main class="flex-grow pb-16 md:pb-0"><?php echo $__env->yieldContent('content'); ?></main>

<?php echo $__env->make('layouts.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php echo $__env->make('layouts.mobile-drawer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
