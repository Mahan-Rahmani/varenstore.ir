...
<?php if(isset($discountedProducts) && $discountedProducts->isNotEmpty()): ?>
    <section class="mb-10" x-data="{
        ...
        <div class="relative bg-gradient-to-l from-[#e01438] via-[#ef394e] to-[#e01438] rounded-3xl p-4 sm:p-6 shadow-xl shadow-red-500/20 overflow-hidden">
            ...
            <div x-ref="track"
                ...
                <?php $__currentLoopData = $discountedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="w-48 sm:w-52 shrink-0 bg-white rounded-2xl p-3 flex flex-col justify-between border border-white/60 shadow-md hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 group">
                        <div class="relative aspect-[3/4] bg-zinc-50 rounded-xl overflow-hidden mb-2.5">
                            <?php if($deal->featured_image): ?>
                                <img src="<?php echo e($deal->featured_image); ?>" alt="<?php echo e($deal->name); ?>" loading="lazy" class="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-500">
                            <?php else: ?>
                            ...
                            <span class="absolute top-2 right-2 bg-[#ef394e] text-white text-[11px] font-black px-2 py-0.5 rounded-full shadow-md">
                                <?php echo e($deal->discount_percentage); ?>٪
                            </span>
                            <?php if($deal->stock <= 5 && $deal->stock > 0): ?>
                                <span class="absolute bottom-2 right-2 left-2 bg-amber-500/90 backdrop-blur-sm text-white text-[9px] font-extrabold text-center py-0.5 rounded-md shadow-sm">
                                    تنها <?php echo e($deal->stock); ?> عدد باقیست
                                </span>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="flex-1 flex flex-col justify-between">
                            <div>
                                <span class="text-[10px] font-bold text-zinc-400 block mb-1 truncate"><?php echo e($deal->category?->name ?? 'وارِن | VAREN'); ?></span>
                                <h4 class="font-bold text-zinc-900 text-xs line-clamp-2 leading-relaxed group-hover:text-[#ef394e] transition-colors">
                                    <a href="<?php echo e(route('product.show', $deal->slug)); ?>"><?php echo e($deal->name); ?></a>
                                </h4>
                            </div>

                            <div class="mt-3 pt-2.5 border-t border-zinc-100 flex flex-col items-end gap-1">
                                <span class="text-[11px] text-zinc-400 line-through"><?php echo e(number_format($deal->price)); ?></span>
                                <div class="flex items-baseline gap-1 text-black font-black">
                                    <span class="text-sm font-black text-zinc-950"><?php echo e(number_format($deal->sale_price)); ?></span>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/shop/partials/deals_slider.blade.php ENDPATH**/ ?>