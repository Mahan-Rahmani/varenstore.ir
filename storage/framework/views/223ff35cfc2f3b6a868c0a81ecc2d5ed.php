...
<head>
    ...
    <title>پنل مدیریت - <?php echo e(config('app.name', 'چاپ تیشرت وارِن')); ?></title>
...
<body x-data="{ mobileMenuOpen: false }" class="min-h-screen flex flex-col md:flex-row font-sans text-slate-800 bg-slate-100 antialiased selection:bg-rose-500 selection:text-white">
    <?php echo $__env->make('layouts.admin-mobile-header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('layouts.admin-mobile-drawer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!-- Admin Sidebar -->
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col justify-between hidden md:flex shrink-0 border-l border-slate-800">
        <div>
            ...
            <div class="h-16 flex items-center px-6 border-b border-slate-800">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3">
                    <img src="<?php echo e(asset('images/logo/VAREN_WHITE_WITHOUT%20LOGOTYPE%20AND%20SLOGAN.png')); ?>" alt="VAREN" class="h-9 w-9 object-contain">
        ...
        <div class="p-4 border-t border-slate-800">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 px-4 py-2.5 text-xs font-bold text-slate-400 hover:text-white transition rounded-xl hover:bg-slate-800">
    ...
    <div class="flex-1 flex flex-col min-h-0 overflow-y-auto">
        ...
        <header class="h-16 bg-white border-b border-slate-200 px-6 hidden md:flex items-center justify-between sticky top-0 z-30 shadow-xs">
            <h1 class="text-sm font-black text-slate-800"><?php echo $__env->yieldContent('title', 'کنترل پنل مدیریت'); ?></h1>
            <div class="flex items-center gap-4 text-xs font-bold">
                <span class="text-slate-500">مدیر آنلاین: <strong class="text-slate-900"><?php echo e(auth()->user()->name); ?></strong></span>
    ...
    <?php echo $__env->make('layouts.admin-mobile-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
